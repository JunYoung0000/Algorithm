...
<td>"s"</td>
      ...
      </table><div class="highlight" bis_skin_checked="1"><pre class="codehilite"><code>각 부분 문자열을 순서대로 이어 붙인 문자열은 "programmers"입니다. 따라서 "programmers"를 return 합니다.
</code></pre></div>
